<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-gray-900">Expense Report</h2>
                <p class="text-gray-600 text-sm mt-1">Track all expense transactions and payments</p>
            </div>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg border border-gray-100 mb-8">
                <div class="border-b border-gray-200 px-6 py-6 bg-gradient-to-r from-red-50 to-orange-50">
                    ...
                    <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                        ...
                        <div class="flex items-end gap-2 col-span-1 lg:col-span-2">
                            ...
                            @can('reports.download')
                                <a
                                    class="flex-1 inline-flex items-center justify-center px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition shadow-sm"
                                    href="{{ route('reports.expense', array_merge(request()->query(), ['pdf' => 1])) }}"
                                ...
                                <a
                                    ...
                                    href="{{ route('reports.expense', array_merge(request()->query(), ['download' => 1])) }}"
            ...
            <div class="bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden">
                <div class="border-b border-gray-200 px-6 py-6 bg-gradient-to-r from-red-50 to-orange-50">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Complete list of all expense entries</p>
                </div>
