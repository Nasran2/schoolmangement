<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-gray-900">EPF Report</h2>
                <p class="text-gray-600 text-sm mt-1">Teacher EPF deductions from salary payments</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-lg border border-gray-100 mb-8">
                <div class="border-b border-gray-200 px-6 py-6 bg-gradient-to-r from-blue-50 to-indigo-50">
                    <h3 class="text-lg font-semibold text-gray-800">Filter EPF</h3>
            ...
            <div class="bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden mb-8">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-800">Teacher EPF Summary</h3>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-right">
                                        <a class="inline-flex items-center px-3 py-1.5 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md"
                                           href="{{ route('reports.teacher_epf', array_merge(request()->query(), ['teacher_id' => $row['teacher']?->id])) }}">
                                            View
                                        </a>
                                    </td>
                                </tr>
