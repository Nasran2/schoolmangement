<x-app-layout>
    <x-slot name="header">
        <h1 class="text-xl font-bold text-gray-800">Edit Extra Class</h1>
        <p class="text-sm text-gray-500 mt-1">Update session details and students.</p>
    </x-slot>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                         ...
                         <input type="text" name="name" value="{{ old('name', $extraClass->name) }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-shadow" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="payment_type" x-model="paymentType" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-shadow" required>
                            <option value="daily" @selected(old('payment_type', $extraClass->payment_type)==='daily')>Daily (Per Session)</option>
                            <option value="monthly" @selected(old('payment_type', $extraClass->payment_type)==='monthly')>Monthly</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" name="fee" value="{{ old('fee', $extraClass->fee) }}" class="pl-10 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-shadow" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">Rs</span>
                            <input type="number" step="0.01" min="0" name="teacher_payment" value="{{ old('teacher_payment', $extraClass->teacher_payment) }}" class="pl-10 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-shadow">
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                             ...
                             <input type="time" name="start_time" value="{{ old('start_time', $extraClass->start_time) }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-shadow">
                        </div>
                        <div>
                             <label class="block text-sm font-semibold text-gray-700 mb-1">End Time</label>
                             <input type="time" name="end_time" value="{{ old('end_time', $extraClass->end_time) }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-shadow">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2" x-show="paymentType === 'monthly'">
                        ...
                        <input type="date" name="payment_start_date" value="{{ old('payment_start_date', $extraClass->payment_start_date?->format('Y-m-d')) }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-shadow">
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center gap-3 mt-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="active" value="1" class="sr-only peer" @checked(old('active', $extraClass->active))>
            ...
            <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">Manage enrolled students.</p>
                </div>
                <div class="p-6">
                    <div class="space-y-3">
            ...
            <div class="flex items-center justify-end gap-4">
                ...
                <button type="submit" class="px-5 py-2.5 rounded-lg bg-indigo-600 text-white font-medium hover:bg-indigo-700 shadow-sm transition-colors ring-offset-2 focus:ring-2 focus:ring-indigo-500">Update Extra Class</button>
            </div>
        </div>
    </form>
</x-app-layout>
