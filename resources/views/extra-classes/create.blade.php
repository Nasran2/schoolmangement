        ...
        <div class="space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-2">
                            ...
                            @foreach($days as $day)
                                <label class="inline-flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
                                    <input type="checkbox" name="week_days[]" value="{{ $day }}" @checked(in_array($day, old('week_days', []))) class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                    ...
                    <div class="space-y-4" x-data="{ instType: '{{ old('teacher_id') ? 'internal' : (old('visiting_teacher_id') ? 'visiting' : 'internal') }}' }">
